...
public class ControllerNinjaPlayerOne : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject temp3 = GameObject.FindWithTag("Player1");
        if (temp3 != null)
        {
        ...
        GameObject temp4 = GameObject.FindWithTag("Player2Energy");
        if (temp4 != null)
        {
